  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard title="Орташа балл" value="4.3" icon={BarChart3} color="blue" />
        <StatCard title="Қатысу %" value="96%" icon={CheckCircle} color="green" />
        <StatCard title="Тапсырмалар" value={2} icon={ClipboardList} color="orange" />
        <StatCard title="Бүгінгі сабақтар" value={7} icon={Calendar} color="blue" />
      </div>
